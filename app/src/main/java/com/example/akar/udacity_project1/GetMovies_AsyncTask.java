 ...
 */
public class GetMovies_AsyncTask extends AsyncTask<String,Void,Void> {
    private Movie_details[] movies = new Movie_details[20];
    ...
    protected void onPostExecute(Void v) {
        ...
        if(!internet)
        {
            Toast toast = Toast.makeText(context,"No interenet access", Toast.LENGTH_LONG);
            toast.show();
            return;
        }
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                Movie_details imageClick = movies[position];
                MoviedetailsFragment movieDetailsFragment = new MoviedetailsFragment();
                movieDetailsFragment.setMovie(imageClick,context);
    ...
    private Movie_details[] fetchMovies(String sortBy)
    {
        Log.d("fetch","fetch");
...
/*            httpURLConnection.setDoInput(true);*/
            ...
            try {
                ...
                for(int i=0; i<jsonArray.length(); i++) {
                    ...
                    movies[i] = new Movie_details(movie.get(ORIGINAL_TITLE_TAG).toString(),IMAGE_BASE_URL + IMAGE_SIZE + movie.get(POSTER_IMAGE_PATH_TAG).toString(),
